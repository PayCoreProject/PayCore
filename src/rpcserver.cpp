...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Paycore server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PCR features */
        {"paycore", "masternode", &masternode, true, true, false},
        {"paycore", "masternodelist", &masternodelist, true, true, false},
        {"paycore", "mnbudget", &mnbudget, true, true, false},
        {"paycore", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"paycore", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"paycore", "mnsync", &mnsync, true, true, false},
        {"paycore", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"paycore", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use paycored, or the -server option to paycore-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> paycore-cli " + methodname + " " + args + "\n";
}

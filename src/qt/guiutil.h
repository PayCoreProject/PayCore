...
/** Utility functions used by the PCR Qt UI.
 */
namespace GUIUtil
{
...
// Render PCR addresses in monospace font
...
// Parse "paycore:" URI into recipient object, return true on successful parsing

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Paycore-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Paycore address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and paycore: URIs)"));
...
//AAAA LimxDev Coinmix Tab
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Paycore Core"), this);
    aboutAction->setStatusTip(tr("Show information about Paycore Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Paycore"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Paycore addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Paycore addresses"));
    ...
    openAction->setStatusTip(tr("Open a Paycore: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Paycore Core help message to get a list with possible Paycore command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Paycore Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Paycore network", "", count));
}
...
{
    QString strTitle = tr("Paycore Core"); // default title

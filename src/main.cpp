...
#if defined(NDEBUG)
#error "Paycore cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Paycore Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if(nHeight > 0 && nHeight <= 500) {
        nSubsidy = 1 * COIN;
	} else if (nHeight > 500 && nHeight <= 15000) {
		nSubsidy = 1 * COIN;

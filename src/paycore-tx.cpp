...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Paycore Core paycore-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  paycore-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded paycore transaction") + "\n" +
                               "  paycore-tx [options] -create [commands]   " + _("Create hex-encoded paycore transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded paycore transaction

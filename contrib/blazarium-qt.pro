...
RESOURCES += src/qt/paycore.qrc src/qt/paycore_locale.qrc

TRANSLATIONS += src/qt/locale/paycore_bg.ts \
                src/qt/locale/paycore_de.ts \
                src/qt/locale/paycore_en.ts \
                src/qt/locale/paycore_es.ts \
                src/qt/locale/paycore_fi.ts \
                src/qt/locale/paycore_fr.ts \
                src/qt/locale/paycore_it.ts \
                src/qt/locale/paycore_ja.ts \
                src/qt/locale/paycore_pl.ts \
                src/qt/locale/paycore_pt.ts \
                src/qt/locale/paycore_ru.ts \
                src/qt/locale/paycore_sk.ts \
                src/qt/locale/paycore_sv.ts \
                src/qt/locale/paycore_vi.ts \
                src/qt/locale/paycore_zh_CN.ts \
                src/qt/locale/paycore_zh_TW.ts
